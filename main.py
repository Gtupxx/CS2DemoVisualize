...
src.config.DEMO_PATH = (
    r"C:\\Users\\11523\\AppData\\Roaming\\Wmpvp\\demo\\9210669270362294028_0.dem"
)

from src.overlay import KeyOverlay, MouseOverlay
...
if __name__ == "__main__":
    ...
    threading.Thread(
        target=play_demo,
        args=(pause_flag, skip_to_tick, skip_to_tick_lock, mouseOverlay),
        daemon=True,
    ).start()
